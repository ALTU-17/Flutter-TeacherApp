...
//https://sms.arnoldcentralschool.org/Test_ParentAppService/upload_teacher_profile_image_into_folder
  ...
  Future<TeacherDetails?> getTeacherDetails() async {
    ...
    final verification = cachedUser.teacherVerification;
    final academicYr = '2024-2025'; //cachedUser.academicYr;
    final regId = cachedUser.regId;
    ...
    try {
      ...
      Utils.toast("Failed to load teacher details");
      return null;
    } catch (e) {
      Utils.toast("Error fetching teacher details: ${e.toString()}");
      return null;
    }
  }
