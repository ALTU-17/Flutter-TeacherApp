...
import 'package:teacherapp/features/auth/views/login_view.dart';
  ...
  Widget build(BuildContext context,ref) {
    ...
    List<CardItem> cardItems = [
      ...
      CardItem(
        ...
        title: 'LogOut',
        onTap: () {
         showDialog(context: context, builder: (context) => LogoutConfirmationDialog(),);
      ...
      CardItem(
        ...
        //     Navigator.push(
        //   context,
        //   MaterialPageRoute(builder: (_) => PasswordView()),
        // );
        },
      ),
      CardItem(
