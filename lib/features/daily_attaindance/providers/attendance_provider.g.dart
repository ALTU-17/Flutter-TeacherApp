...
String _$attendancePHash() => r'91a2bc587b3ca9bc018de07eec5e6e48a86da91f';
...
abstract class _$AttendanceP
    extends BuildlessAutoDisposeAsyncNotifier<List<Students>> {
  late final StudentBody param;

  FutureOr<List<Students>> build(
    StudentBody param,
  );
}
...
/// See also [AttendanceP].
class AttendancePFamily extends Family<AsyncValue<List<Students>>> {
  /// See also [AttendanceP].
...
class AttendancePProvider
    extends AutoDisposeAsyncNotifierProviderImpl<AttendanceP, List<Students>> {
  /// See also [AttendanceP].
  AttendancePProvider(
    StudentBody param,
  ) : this._internal(
  ...
  @override
  FutureOr<List<Students>> runNotifierBuild(
  ...
  @override
  AutoDisposeAsyncNotifierProviderElement<AttendanceP, List<Students>>
      createElement() {
...
mixin AttendancePRef on AutoDisposeAsyncNotifierProviderRef<List<Students>> {
  /// The parameter `param` of this provider.
  StudentBody get param;
}

class _AttendancePProviderElement
    extends AutoDisposeAsyncNotifierProviderElement<AttendanceP, List<Students>>
    with AttendancePRef {
