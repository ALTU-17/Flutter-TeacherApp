...
class HomeWorkDashBoardView extends StatelessWidget {
    ...
    final List<Map<String, String>> notes = [
      {
        ...
        'date': '11-03-2025',
        'description':
            ' Test note for EngliTest note for EngliTest note for EngliTest note for English.',
...
class _HomeworkNoteCardState extends State<HomeworkNoteCard> {
  ...
  bool showEditActions =
      false; // New state to toggle edit, delete, and check icons
                    ...
                    IconButton(
                      ...
                      onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => const EditHomeWork()),
                        );
                      },
                    ),
                    ...
                    IconButton(
                      ...
                      onPressed: () {
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (context) =>
                                ViewedByHomeWork(note: widget.note),
                          ),
                        );
                        setState(() {
                          showActions = false;
