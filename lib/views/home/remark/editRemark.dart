  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    Future<void> _saveRemark() async {
      ...
      try {
        ...
        // Send ONLY newly uploaded filenames (as required).
        // If none were uploaded in this session, send [""].
        final List<String> namesToSend = newlyUploadedFileNames.value.isNotEmpty
            ? newlyUploadedFileNames.value
            : [''];

        final String fileNamePayload = json.encode(namesToSend);
        print('Saving remark, fileName payload: $fileNamePayload');
        ...
        if (success['status'] == true) {
          // Clear session list after successful save
          newlyUploadedFileNames.value = [];
