...
class TeacherNoteDashBoardView extends StatelessWidget {
                    ...
                    IconButton(
                      ...
                      onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => const EditTeacherNote()),
                        );
                      },
                    ),
                    ...
                    IconButton(
                      ...
                      onPressed: () {
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (context) =>
                                ViewTeacherNote(note: widget.note),
                          ),
                        );
                        setState(() {
                          showActions = false;
                    ...
                    IconButton(
                      ...
                      onPressed: () {
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (context) =>
                                ViewedByTeacherNote(note: widget.note),
                          ),
                        );
                        setState(() {
                          showActions = false;
